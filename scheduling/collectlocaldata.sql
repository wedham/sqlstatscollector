...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Data collection [sqlstatscollector]', 
		@enabled=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Run the collection PROCEDURE', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Collection Schedule [sqlstatscollector]', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
